                  ...
                  Stack(
                    children: [
                      ...
                      Container(
                        ...
                        child: ClipRRect(
                          borderRadius: BorderRadius.circular(CSizes.productImageRadius),
                          child: Image(image: AssetImage(imageProduct), fit: BoxFit.cover),
                        ),
                      ),
                      ...
                      if (salePrice != '0')
                        Positioned(
                          ...
                          child: CRoundedContainer(
                            ...
                            child: Text('$salePrice%', style: Theme.of(context).textTheme.labelLarge!.apply(color: CColors.dark),),
                          ),
                        )
                    ]
                  ),
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(productBrand, overflow: TextOverflow.ellipsis, maxLines: 1, style: Theme.of(context).textTheme.labelMedium),
                  Text('$price VND', maxLines: 1, overflow: TextOverflow.ellipsis, style: Theme.of(context).textTheme.titleSmall),
                  // Rate and button
                  Row(
